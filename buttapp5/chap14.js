...
function placeOrder() {
    ...
    // get the pizza price
    var orderPrice = calculatePrice(numPizzas, typePizza, size);
    // get the delivery price
    var deliveryPrice = calculateDelivery(orderPrice, deliveryCity, birthday, size);
 ...
 */
function calculatePrice(numPizzas, typePizza, size) {

    var orderPrice = (Number(numPizzas) * 10);
    var extraCharge = 0;

    // calculate extraCharge, if there is one
    if (typePizza === "supreme" || size ==="large") {
